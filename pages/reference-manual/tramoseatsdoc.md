...
-   **Refresh data** – updates the input data and executes the seasonal
    ...
    *Workspace* window. Finally, chose the **Refresh data** option from
    ...
    (see [Modelling-Specifications](modelling-specifications.html) and [Seasonal adjustment-Specifications](sa-specifications.html)).cument select *TramoSeats* from the *Seasonal Adjustment* \\(\rightarrow\\) *Statistical methods*
\\(\rightarrow\\) *Single Analysis* menu.
