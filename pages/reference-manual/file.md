...
* **Save Workspace As…** – saves the current workspace under the name chosen by the user in the chosen location. The workspace can be re-opened at a later point in time; 
