...
frequency $$ω_{j}$$ :[^74]
  ...
  $$
  I\left(\omega_{j} \right) = \sum_{\left|k\right|< n}^{\_}\widehat{\gamma}\left(k\right)e^{-ik\omega_{j}} = \widehat{\gamma}\left( 0\right) + 2\sum_{k=1}^{n-1}\widehat{\gamma}\left(k\right)\cos{(k\omega_{j})}}
  $$   \[7.116\]
